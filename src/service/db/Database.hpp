...
public:
    ...
    QUERY(createChatMessage,
          "INSERT INTO chat_line (chat_id, user_id, line_text, created_at, is_read, message_hash) VALUES (:msg.chat_id, :msg.peerId, :msg.message, :msg.timestamp, :msg.is_read, :msg.messageHash);",
          PREPARE(true),
          PARAM(oatpp::Object<MessageDto>, msg))
